    ...
    <div className="space-y-10 w-full animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 animate-slide-right">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
            Manage deliveries, inspections, and acceptances after the Notice to Proceed (NTP) has been issued in
            Procurement.
          </p>
        </div>
      </div>
      ...
      <Card className="card-animated animate-slide-up">
        ...
        <CardContent className="p-0">
          {cases.length === 0 ? (
            <EmptyState
              title="No supply cases found"
              description={
                filterMode === 'pre-supply'
                  ? 'No cases currently need Supply actions. Try switching to Post-Supply filter or adjusting your search.'
